...
function Formatter() {
  ...
  function formatSubjectData(data) {
    ...
    if (data.point) subject.points = parseInt(data.point[0])
  ...
  function formatCourseData(courseData) {
    ...
    if (courseData.point && typeof courseData.point[0] !== 'object') course.points = parseInt(courseData.point[0])
    if (courseData.description && typeof courseData.description[0] !== 'object') course.description = turndownService.turndown(courseData.description[0])
    if (courseData.centralContent && typeof courseData.centralContent[0] !== 'object') course.centralContent = turndownService.turndown(courseData.centralContent[0])
